  ...
  return (
    <div className="flex  flex-col items-center bg-white text-gray-800 min-h-screen">
      ...
      <div className="w-full max-w-5xl mx-auto relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="bg-[url(/textbox.png)] p-10 w-80 h-60 mt-80 text-center">
            <h2 className="text-3xl  mb-3 font-lustria mb-2 text-gray-700">
              Lauriston House
            </h2>
      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col items-center px-8 py-12 bg-[url(/bgtext.jpg)]  text-gray-700 text-center">
        ...
        <h2 className="text-2xl font-lustria mb-4">We are getting married!</h2>
        <p className="mb-3 font-lustria">
          Please come celebrate this special moment with us as we begin a new
          chapter together.
        </p>
        <p className="mb-8 font-lustria">
          Even if distance keeps us apart, your love and warm wishes mean the
          world to us.
        </p>
        ...
        <div className="grid grid-cols-2 gap-8 w-full  text-gray-700 max-w-md mt-4">
          ...
          <div className="flex flex-col  items-center">
            ...
            <h3 className="text-sm font-lustria text-gray-400">The Groom</h3>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-sm text-gray-400 font-lustria">The Bride</h3>
        ...
        <div className="flex flex-col items-center mt-15">
          <p className=" font-lustria">From two stories to one -</p>
          <p className=" font-lustria">This is our shared chapter</p>
          <p className=" font-lustria">
            And our little cat, Dot, is joining our journey as well
          </p>
          <Image
            src="/intro_dot.png"
            alt="Dot"
